...
var DEFAULT_CONFIG = {
	UNCHECKED_NORM : '/static/images/unchecked.gif',
	UNCHECKED_HILI : '/static/images/unchecked_highlighted.gif',
	INTERMEDIATE_NORM : '/static/images/intermediate.gif',
	INTERMEDIATE_HILI : '/static/images/intermediate_highlighted.gif',
	CHECKED_NORM : '/static/images/checked.gif',
	CHECKED_HILI : '/static/images/checked_highlighted.gif'
};




function setwarning(triStateBoxField){

    var label = document.getElementById('lbl'+triStateBoxField.id);
    if (triStateBoxField.value == STATE_ALL)
    {
        label.style.color = "red";
        label.style.fontWeight = "bold";
        label.innerHTML = "Base: Planstand";

    }
    else if (triStateBoxField.value == STATE_SOME)
    {
        label.style.color = "blue";
        label.style.fontWeight = "bold";
        label.innerHTML = "Available for the project";
    }
    else
    {
        label.style.color = "blue";
        label.style.fontWeight = "bold";
        label.innerHTML = "Not used";
    }
    return 0;
}
